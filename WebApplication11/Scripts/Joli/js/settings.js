var site_settings = '<div class="ts-button">'
    ...
    + '<div class="ts-themes">'
    + '<a href="#" class="active" data-theme="../css/theme-default.css"><img src="../Scripts/Joli/img/themes/default.jpg"/></a>'
    + '<a href="#" data-theme="../css/theme-brown.css"><img src="../Scripts/Joli/img/themes/brown.jpg"/></a>'
    + '<a href="#" data-theme="../css/theme-blue.css"><img src="../Scripts/Joli/img/themes/blue.jpg"/></a>'
    + '<a href="#" data-theme="../css/theme-white.css"><img src="../Scripts/Joli/img/themes/light.jpg"/></a>'
    + '<a href="#" data-theme="../css/theme-black.css"><img src="../Scripts/Joli/img/themes/black.jpg"/></a>'
    + '</div>'
    + '<div class="ts-title">Layout</div>'
    + '<div class="ts-row">'
    + '<label class="check"><input type="radio" class="iradio" name="st_layout_boxed" value="0" checked/> 全屏展示</label>'
    + '</div>'
    + '<div class="ts-row">'
    + '<label class="check"><input type="radio" class="iradio" name="st_layout_boxed" value="1"/> 居中展示</label>'
    + '</div>'
    + '<div class="ts-title">Options</div>'
    + '<div class="ts-row">'
    + '<label class="check"><input type="checkbox" class="icheckbox" name="st_head_fixed" value="1"/> 锁定头部</label>'
    + '</div>'
    + '<div class="ts-row">'
    + '<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_fixed" value="1" checked/> 锁定菜单栏</label>'
    + '</div>'
    + '<div class="ts-row">'
    + '<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_scroll" value="1"/> 浮动菜单栏</label>'
    + '</div>'
    + '<div class="ts-row">'
    + '<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_right" value="1"/> 菜单栏右侧</label>'
    + '</div>'
    + '<div class="ts-row">'
    + '<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_custom" value="1"/> 个性菜单</label>'
    + '</div>'
    + '<div class="ts-row">'
    + '<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_toggled" value="1"/> 展开/收起菜单</label>'
    + '</div>'
