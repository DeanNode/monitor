var provinceList = [
    ...
    {
        name: '天津市', cityList: [
            { name: '天津市', areaList: ['和平区', '河东区', '河西区', '南开区', '河北区', '红桥区', '塘沽区', '汉沽区', '大港区', '东丽区', '西青区', '津南区', '北辰区', '武清区', '宝坻区', '宁河区', '静海区', '蓟州区'] }
        ]
    },
    {
        name: '重庆市', cityList: [
    ...
    },
    {
        name: '山东省', cityList: [
            ...
            { name: '青岛市', areaList: ['市南区', '市北区', '四方区', '黄岛区', '崂山区', '李沧区', '城阳区', '即墨区', '胶州市', '平度市', '胶南市', '莱西市'] },
